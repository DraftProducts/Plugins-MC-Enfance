...
public class ScoreboardManager {
	...
	public void loadScoreboard() {
		...
		scoreboardGame.get(player).setLine(3, ChatColor.GRAY + "Début dans: " + ChatColor.GREEN + new SimpleDateFormat("ss").format(new Date(Task.timer * 1000)));
	...
	public static void loadScoreboardGame(Player pls) {
		if(ScoreboardManager.scoreboardGame.containsKey(pls)) {
			...
			ScoreboardManager.scoreboardGame.get(pls).setLine(2, " §9Bleu : 0");
			ScoreboardManager.scoreboardGame.get(pls).setLine(3, " §cRouge : 0");
